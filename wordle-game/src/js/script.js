const listaDePalavras = ["piano", " Crane", "festa", "sagaz", "amigo", "nobre", "termo", "nuvem"];
...
function sortearPalavra() {
  ...
  return listaDePalavras[indice].toLowerCase();
}

// Inicializa a palavra secreta com um sorteio
...
function verificarTentativa() {
  for (let i = 0; i < 5; i++) {
    ...
    const letraCorreta = palavraSecreta[i];
